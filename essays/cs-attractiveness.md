...
layout: essay
type: essay
title: "Computer Science Attractiveness"
...
This course provides an introduction to the components of software engineering, as well as some useful tools after we graduate, which gives us the stepping stone needed to create and design our own websites and applications. Personally, I’ve always wanted to create the perfect applications that would solve my own problems, instead of relying on already made applications. It may sound biased with the word “perfect”, but it is because only I know exactly how I want my own application to work. As long as I’m satisfied with my own application, I would have no future expectations for other people to use it. But if there are some people that would use it, I would like to relish the feeling that I’ve made a useful application not just for myself.
