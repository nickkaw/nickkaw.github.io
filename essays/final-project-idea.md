...
- People without an account
  - Able to sign up
  - Able to report reviews without having to sign up

- User home Page
  - Shows all food places with option to add a review
  - Shows number of reviews that a user has made
  - User can add a follow up review to place
 
- Admin home Page
  - Shows all users, and a log of reviews from users
  - List of food places that can be added or 
  - Ability to review reports and remove users
...
Admins have the ability to remove inappropriate comments within the comment section of the restaurant. They could also add or remove restaurants as well.
...
Add  a “comment” system where users can discuss with one another about their favorite items from the location or discuss problems about the restaurant.

Add a “report” system where users can report each other for inappropriate comments and behavior. This report will be seen to the administrator of the site.
