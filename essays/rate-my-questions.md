...
## Conclusion
  ...
  Ultimately, there are ways in which individuals may rate certain questions. According to Raymond's guide, questions fall into two general categories, those that are "smart" and those that are "not smart". As shown in the examples above, questions that are "not smart" appear to be very sloppy and lack resilience. Questions that are "smart" appear well thought-out and provide merit and trust to readers. Although the idea of Raymond's "not smart" and "smart" questions may include computer science related communities, it can be applicable to everyday settings. This does not necessarily limit to computer sciencen online setting, but to a To ask a smart question, try to ask as a decent human being and do not take advantage of others. 
